...
2. Calculate an innovation score from 0-100:
   - 0-20: Minimal innovation (few patents/papers, low citations)
   - 21-40: Low innovation (some activity but not significant)
   - 41-60: Moderate innovation (steady activity, decent citations)
   - 61-80: High innovation (strong activity, high-quality citations)
   - 81-100: Breakthrough innovation (exceptional activity, landmark patents)
...
Be objective and data-driven. Higher patent/paper counts with strong PageRank weighting indicate higher innovation.
