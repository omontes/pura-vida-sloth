...
# Import all agents
from src.agents.agent_01_tech_discovery.agent import tech_discovery_agent
from src.agents.agent_02_innovation.agent import innovation_scorer_agent
from src.agents.agent_03_adoption.agent import adoption_scorer_agent
from src.agents.agent_04_narrative.agent import narrative_scorer_agent
from src.agents.agent_05_risk.agent import risk_scorer_agent
from src.agents.agent_06_hype.agent import hype_scorer_agent
from src.agents.agent_07_phase.agent import phase_detector_agent
from src.agents.agent_08_analyst.agent import llm_analyst_agent
from src.agents.agent_09_ensemble.agent import ensemble_agent
from src.agents.agent_10_chart.agent import chart_generator_agent
from src.agents.agent_11_evidence.agent import evidence_compiler_agent
from src.agents.agent_12_validator.agent import output_validator_agent
